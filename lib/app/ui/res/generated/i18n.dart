...
class S {
  ...
  String get app_name {
    return Intl.message("attend", name: 'app_name');
  }

  String get app_subjudul {
    return Intl.message("tetot", name: 'app_subjudul');
  }
  ...
  String get attendance_bar {
    return Intl.message("Attendance", name: 'attendance_bar');
  }
